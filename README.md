...
│
├── 01-Active-Directory/
│   ├── New-ADUserBulkOnboarding.ps1    # CSV'den toplu kullanıcı açma ve şifre üretimi
│   ├── Remove-ADUserOffboarding.ps1    # Personel ayrılışında hesabı dondurma ve karantina
...
İK'dan gelen CSV dosyasını okuyarak kullanıcıları oluşturur, rastgele 12 karakterlik geçici şifre atar, Türkçe karakterleri normalize eder ve departman güvenlik grubuna ekler:
...
Ayrılan personelin hesabını derhal kapatır, gruplardan temizler, açıklama alanına zaman damgası düşer ve karantina OU'suna taşır:
